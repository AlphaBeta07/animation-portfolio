        ...
        <footer className="w-full bg-[#0a0a0a] pt-20 pb-10 px-4 overflow-hidden relative">
            ...
            <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-end justify-between border-t border-white/10 pt-10">
                ...
                <div className="flex gap-4 mb-10 md:mb-0">
                    <motion.a
                        href="mailto:anishlandgae007@gmail.com"
                ...
                <div className="flex flex-col md:flex-row gap-8 md:gap-16 text-zinc-400">
                    <div className="flex flex-col gap-4">
                        ...
                        <a href="https://www.linkedin.com/in/anish-landage-774511298/" target="_blank" rel="noopener noreferrer" className="hover:text-[#A8E524] transition-colors">LinkedIn</a>
                        <a href="https://github.com/AlphaBeta07" target="_blank" rel="noopener noreferrer" className="hover:text-[#A8E524] transition-colors">GitHub</a>
                        <a href="https://www.instagram.com/anishlandage/" target="_blank" rel="noopener noreferrer" className="hover:text-[#A8E524] transition-colors">Instagram</a>
                    </div>
                    <div className="flex flex-col gap-4">
                        ...
                        <div className="flex flex-col gap-1">
                            ...
                            <a href="mailto:anishlandgae007@gmail.com" className="hover:text-[#A8E524] transition-colors text-sm">anishlandgae007@gmail.com</a>
                            <a href="tel:7219054105" className="hover:text-[#A8E524] transition-colors text-sm">+91 7219054105</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="max-w-7xl mx-auto mt-20 text-center md:text-left text-zinc-600 text-sm">
                © 2024 Anish. All rights reserved.
            </div>
